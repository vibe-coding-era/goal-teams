...
description: 定义 V2.68 可执行 Graph 的编译、调度、权限、恢复与证据边界。
tags: [goal-teams, v2.68, graph-engineering, runtime]
...
- `execution_asset_generation`: `V2.65`；V2.68 只改变 Product/Policy 输出控制，不复制或冒充新的 Graph Runtime。
