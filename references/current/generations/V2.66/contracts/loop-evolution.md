...
tags: [goal-teams, v2.66, loop, reflection, evolution]
...
- V2.66 复用 `schemas/v2.65/loop-review.schema.json` 与 `schemas/v2.65/loop-coordinator.schema.json` 的 Graph Execution contract；append receipt、round receipt、reconcile receipt、Capsule digest 与文件 exact readback 保持同一证明强度。
