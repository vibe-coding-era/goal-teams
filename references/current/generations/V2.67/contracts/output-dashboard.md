...
description: 定义 V2.67 六字段 Envelope 的结果内紧凑任务看板、Context 与 P/D/C/A LOOP 投影。
tags: [goal-teams, v2.67, output, dashboard, loop]
...
- `contract_id`: `CONTRACT-OUTPUT-DASHBOARD-V267`
...
- 结构化输入与 Markdown 输出由 `schemas/v2.67/output-dashboard.schema.json` 和 `scripts/v267/output_dashboard.py` 约束。
