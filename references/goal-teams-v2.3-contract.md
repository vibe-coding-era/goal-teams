...
以下历史扩展在当前 V2.45 只由 `goal-teams-self-release-v2.45` Profile 加载；V2.44/V2.43/V2.42/V2.41/V2.40/V2.39/V2.38 Profile 只用于历史 replay。它们保持 V2.3 schema compatibility，不是 `goal-teams-core-v2.5` 的通用完成条件。
