...
- 只有 `goal-teams` 仓库的当前 V2.46 自发布任务才派生 `goal-teams-self-release-v2.46`；其他任务保持本 Profile，历史 V2.36/V2.37/V2.38/V2.39/V2.40/V2.41/V2.42/V2.43/V2.44/V2.45 数据仍按兼容契约只读 replay。
