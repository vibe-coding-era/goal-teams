...
- `generations/V2.48/snapshot/` 是从冻结 commit/tree 逐字节提取的 38 成员 rollback 快照；`references/current/generations/V2.48/activation-manifest.json` 只指向该隔离根，不复用已被 V2.49 改写的共享路径。
