...
固定 52 条断言、第 9/11 轮、四文件恢复 bundle、四维评分、prompt identity/Cache Evidence/OKF gate、V2.44 发行状态机与公开归档只属于当前 `goal-teams-self-release-v2.44`。只有路由结果明确包含该 `policy_profile` 时才加载 `references/profiles/goal-teams-self-release-v2.44.md`；V2.43/V2.42/V2.41/V2.40/V2.39/V2.38 Profile 只用于历史 replay，普通任务不得从本文件推导这些专项门禁。
...
- 当前路由为 `goal-teams-self-release-v2.44` 时读取 `references/profiles/goal-teams-self-release-v2.44.md`；V2.43/V2.42/V2.41/V2.40/V2.39/V2.38 Profile 只读 replay
