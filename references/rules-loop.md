...
固定 52 条断言、第 9/11 轮、四文件恢复 bundle、四维评分与公开归档只属于 `goal-teams-self-release-v2.36`。只有路由结果明确包含该 `policy_profile` 时才加载 `references/profiles/goal-teams-self-release-v2.36.md`；普通任务不得从本文件推导这些专项门禁。
...
- 路由为 `goal-teams-self-release-v2.36` 时读取 `references/profiles/goal-teams-self-release-v2.36.md`
