...
V2.47 按 prompt-cache manifest 编译 route-static order，当前 self-release refs 指向 V2.47 Profile，V2.46 及更早只读 replay；再追加动态目标包。digest 不冒充 provider key，observer telemetry 不倒灌为当轮事实。
