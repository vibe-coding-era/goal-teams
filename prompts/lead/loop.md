...
固定 52 条断言、四文件、第 9/11 轮、四维评分、GTLOG 和公开归档只在 `policy_profile=goal-teams-self-release-v2.37` 时读取 `references/profiles/goal-teams-self-release-v2.37.md`。普通项目不得加载这些专项门禁。
