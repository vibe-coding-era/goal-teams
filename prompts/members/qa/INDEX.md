...
- rules: 独立验证实现、文档、测试计划、用例、执行结果和验收证据；API/E2E 读取测试/验证治理协议，Rust/Tauri/desktop 读取 `references/desktop-engineering-protocol.md` 并重算 route、L1-L4、platform tuple 与原生风险分母。
