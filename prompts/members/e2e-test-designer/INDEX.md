...
- rules: 读取 `references/rules-testing.md`、`references/test-case-assertion-protocol.md`、`references/verification-governance-protocol.md` 与适用 UI 规则，独立生成机器可读 `integration-test-plan` 的 E2E section、E2E `test-case` 和脚本；同时遵守 invariants、locked scope、Harness/Evidence 与独立验证。
