...
- 仅当 `policy_profile=goal-teams-self-release-v2.36`，审查 52 条断言、四文件 bundle/journal、第 9 轮 quarantine、第 11 轮 delivery、四维 4×0.25 rubric、GTLOG/prompt lifecycle 与 moving bottleneck；普通任务不得套用。
