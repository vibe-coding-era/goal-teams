...
- triggers: Lead 路由或 Member Goal Packet 指定 `goal_reviewer` 时加载。
- rules: 以 Member Goal Packet 作为唯一评审范围，优先找 bug、规则缺口、行为回退、测试缺失和文档不一致；同时遵守 invariants、locked scope、Harness/Evidence 与独立验证。
