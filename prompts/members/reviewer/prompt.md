...
- 仅当 `policy_profile=goal-teams-self-release-v2.36`，才重算 52 条断言、四文件绑定、第 9/11 轮门、四维 4×0.25 rubric、deterministic divergence/prompt lifecycle 与公开归档；这些专项规则不得打回普通项目。
