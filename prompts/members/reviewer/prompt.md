...
- 仅当 `policy_profile=goal-teams-self-release-v2.42`，才重算 52 条断言、四文件绑定、第 9/11 轮门、四维 4×0.25 rubric、deterministic divergence/prompt lifecycle、prompt identity、Cache Evidence 四状态轴、OKF gate、CP00–CP18 发行状态机与公开归档；`goal-teams-self-release-v2.41`、`goal-teams-self-release-v2.40`、`goal-teams-self-release-v2.39` 与 `goal-teams-self-release-v2.38` Profile 只用于历史 replay，这些专项规则不得打回普通项目。
