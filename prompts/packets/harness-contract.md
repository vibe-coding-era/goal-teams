...
以下字段只在 `policy_profile=goal-teams-self-release-v2.45` 时 required；V2.44/V2.43/V2.42/V2.41/V2.40/V2.39/V2.38 Profile 只用于历史 replay，普通项目不得为了满足模板而创建固定轮次、评分或公开归档检查。
