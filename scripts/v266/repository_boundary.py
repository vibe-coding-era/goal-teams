#!/usr/bin/env python3
"""Run and validate the V2.66 repository-boundary integrity gate.
...
def resolve_release_directory(
    ...
    *,
    ...
    release_directory = observed_root / "V2.66"
...
def boundary_contract_digests(
    *, repository_root: Path | None = None
    ...
    validator_paths = (
        ...
        root / "scripts/v266/repository_boundary.py",
    )
    if (
...
def build_boundary_receipt(
    *,
    ...
    receipt: dict[str, Any] = {
        "schema_version": "goal-teams-v2.66-repository-boundary-receipt-v1",
...
def run_repository_boundary(
    *,
    ...
    release_flow = _load_module(
        ...
        root / "scripts/v266/release_flow.py",
    )
