#!/usr/bin/env python3
"""Observe and validate V2.66 fresh-runtime transition receipts.
...
from scripts.v266.release_identity import (  # noqa: E402
    ACTIVE_PATH,
...
ROUTE_BY_STAGE_AND_SIZE = {
    ...
    # V2.66 has no separate Small Release prompt route.  Small Release uses
...
def _verify_handoff_signature(
    ...
    """Verify the V2.65 host-issued V2.66 handoff with the pinned owner key."""
...
def _load_previous_controller_release_identity(root: Path) -> dict[str, Any]:
    """Load the activation-bound published V2.65 identity fail closed."""
...
def validate_controller_handoff(
    ...
    *,
    ...
    """Validate the installed V2.65 host-issued V2.66 handoff."""
    ...
    installed = payload.get("installed_v265_current_state")
