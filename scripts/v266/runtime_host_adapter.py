#!/usr/bin/env python3
"""External host adapter for the V2.65 -> V2.66 runtime handoff.

This module never creates or signs a controller handoff.  It accepts the
V2.66 receipt externally issued by the installed V2.65 host, verifies the
pinned owner key, launches a fresh V2.66 child with ``Popen``, sends the
