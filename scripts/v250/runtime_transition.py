#!/usr/bin/env python3
"""Observe and validate V2.50 fresh-runtime transition receipts.
...
HANDOFF_SCHEMA_VERSION = "goal-teams-v2.50-controller-handoff-receipt-v1"
LAUNCH_SCHEMA_VERSION = "goal-teams-v2.50-runtime-launch-receipt-v1"
CHILD_ACK_SCHEMA_VERSION = "goal-teams-v2.50-runtime-child-ack-v1"
...
HANDOFF_SIGNATURE_NAMESPACE = "goal-teams-v2.50-controller-handoff"
ACTIVE_PATH = "references/current/ACTIVE.json"
POLICY_PROFILE_PATH = "references/profiles/goal-teams-self-release-v2.50.md"
RELEASE_PROFILE_PATH = "references/release-profiles/v2.50.json"
...
ROUTE_BY_STAGE_AND_SIZE = {
    ...
    # V2.50 has no separate Small Release prompt route.  Small Release uses
...
def _load_route_context(
    *,
    ...
    if (
        ...
        or active.get("generation_id") != "V2.50"
    ...
    if (
        ...
        or activation.get("generation_id") != "V2.50"
    ...
    if (
        ...
        or identity.get("target_policy_generation") != "V2.50"
    ...
    if (
        ...
        or prompt_manifest.get("generation_id") != "V2.50"
    ...
    if (
        route_receipt.get("generation_id") != "V2.50"
...
def validate_transition(
    ...
    *,
    ...
    _append_if(
        errors,
        value.get("schema_version")
        != "goal-teams-v2.50-runtime-transition-receipt-v1",
