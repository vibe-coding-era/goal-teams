"""Compile and verify a V2.52 Current route closure."""
...
def compile_route_closure(
    ...
    if generation.get("generation_id") != "V2.52":
        raise RouteClosureError("E_V250_ROUTE_GENERATION", "V2.52 route compiler received another generation")
