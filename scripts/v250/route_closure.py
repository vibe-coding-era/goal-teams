"""Compile and verify a V2.62 Current route closure."""
...
def compile_route_closure(
    ...
    if generation.get("generation_id") != "V2.62":
        raise RouteClosureError("E_V250_ROUTE_GENERATION", "V2.62 route compiler received another generation")
