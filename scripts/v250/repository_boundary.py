#!/usr/bin/env python3
"""Run and validate the V2.63 repository-boundary integrity gate.
...
def resolve_release_directory(
    ...
    *,
    ...
    release_directory = observed_root / "V2.63"
...
def build_boundary_receipt(
    *,
    ...
    receipt: dict[str, Any] = {
        "schema_version": "goal-teams-v2.63-repository-boundary-receipt-v1",
