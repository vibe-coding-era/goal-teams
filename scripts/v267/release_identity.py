"""Immutable V2.67 release/runtime identity constants.

This module is data-only.  It binds the Current V2.67 runtime transition to
the exact published V2.66 predecessor without performing file, process,
...
TARGET_PRODUCT_VERSION = "V2.67"
TARGET_RELEASE_TAG = "v2.67"
PREDECESSOR_PRODUCT_VERSION = "V2.66"
PREDECESSOR_RELEASE_TAG = "v2.66"
...
HANDOFF_SIGNATURE_NAMESPACE = "goal-teams-v2.67-controller-handoff"

ACTIVE_PATH = "references/current/ACTIVE.json"
GENERATION_ROOT = "references/current/generations/V2.67"
PREDECESSOR_RELEASE_IDENTITY_PATH = (
    f"{GENERATION_ROOT}/contracts/predecessor-release-identity.json"
)
POLICY_PROFILE_PATH = "references/profiles/goal-teams-self-release-v2.67.md"
RELEASE_PROFILE_PATH = "references/release-profiles/v2.67.json"
