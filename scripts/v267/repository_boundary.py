#!/usr/bin/env python3
"""Run and validate the V2.67 repository-boundary integrity gate.
...
def resolve_release_directory(
    ...
    *,
    ...
    release_directory = observed_root / "V2.67"
...
def boundary_contract_digests(
    *, repository_root: Path | None = None
    ...
    validator_paths = (
        ...
        root / "scripts/v267/repository_boundary.py",
    )
    if (
...
def build_boundary_receipt(
    *,
    ...
    receipt: dict[str, Any] = {
        "schema_version": "goal-teams-v2.67-repository-boundary-receipt-v1",
...
def run_repository_boundary(
    *,
    ...
    release_flow = _load_module(
        ...
        root / "scripts/v267/release_flow.py",
    )
