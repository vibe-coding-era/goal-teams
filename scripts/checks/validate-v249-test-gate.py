#!/usr/bin/env python3
"""Thin CLI for the V2.49 current-generation test-gate validator."""
...
from scripts.v249.test_gate import build_tdd_chain, validate_test_chain
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = {
            "ok": False,
            "error_code": "E_V249_TEST_CHAIN_INPUT",
            "errors": ["E_V249_TEST_CHAIN_INPUT"],
