#!/usr/bin/env python3
"""V2.50 route-aware development and final-release checker."""
...
CONTRACT_ROOT = ROOT / "references/current/generations/V2.50/contracts"
...
def validate_contracts() -> dict[str, Any]:
    required = {
        "release-route-manifest.json": "goal-teams-v2.50-release-route-v1",
        "release-command-manifest.json": "goal-teams-v2.50-release-command-manifest-v1",
        "release-security-review-manifest.json": "goal-teams-v2.50-release-security-review-v2",
        "public-asset-map.json": "goal-teams-v2.50-public-asset-map-v1",
    }
    errors: list[str] = []
...
def run_full_regression(
    ...
    *,
    ...
    """Run the complete frozen V2.50 Current-generation denominator once."""
    ...
    receipt: dict[str, Any] = {
        "schema_version": "goal-teams-v2.50-release-gate-receipt-v1",
...
def main() -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "goal-teams-v2.50-check-result-v1",
        "passed": passed,
        "s1_passed": s1_passed,
