...
OKF_RELEASE_VERSIONS = {"V2.39", "V2.40", "V2.44", "V2.45", "V2.46", "V2.48", "V2.49", "V2.50", "V2.52"}
STRICT_SNAPSHOT_SCHEMA = "goal-teams-release-snapshot-v2.40"
STRICT_SNAPSHOT_VERSIONS = {"V2.40", "V2.44", "V2.45", "V2.46", "V2.48", "V2.49", "V2.50", "V2.52"}
SUPPORTED_RELEASE_VERSIONS = {
    "V2.33", "V2.34", "V2.35", "V2.36", "V2.37", "V2.38", "V2.39",
    "V2.40", "V2.44", "V2.45", "V2.46", "V2.48", "V2.49", "V2.50", "V2.52",
}
...
def validate_v250_release_identity(
    ...
    """Compare an exact V2.50/V2.52 released identity and asset set."""
    ...
    if (
        ...
        or set(expected) != required
        or set(observed) != required
        or expected.get("version") not in {"V2.50", "V2.52"}
        or observed != expected
    ):
        return {
            "ok": False,
...
def okf_runtime_generation(version: str) -> str:
    ...
    return "v250" if version in {"V2.50", "V2.52"} else "v249"
