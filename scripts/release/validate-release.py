...
SUPPORTED_RELEASE_VERSIONS = {
    ...
    "V2.40", "V2.44", "V2.45", "V2.46", "V2.48", "V2.49", "V2.50", "V2.51",
}
...
def validate_v250_release_identity(
    ...
    """Compare an exact V2.50/V2.51 released identity and asset set."""
    ...
    if (
        ...
        or set(expected) != required
        or set(observed) != required
        or expected.get("version") not in {"V2.50", "V2.51"}
        or observed != expected
    ):
        return {
            "ok": False,
