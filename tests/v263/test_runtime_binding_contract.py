...
from scripts.v263.compatibility import (
...
MANIFEST = ROOT / "references/compatibility/v2.63/manifest.json"


class TestV263RuntimeBindingContract(unittest.TestCase):
    @classmethod
    ...
    def _receipt(self) -> dict[str, object]:
        return {
            "schema_version": "goal-teams-runtime-binding-v2.63-v1",
            "binding_run_id": "RUN-V263-BINDING-0001",
    ...
    def test_binding_requires_run_identity_capture_time_and_exact_digests(self) -> None:
        ...
        expected = {
            "missing-run": "E_V263_RECEIPT_RUN_ID",
            "missing-time": "E_V263_RECEIPT_CAPTURED_AT",
            "digest-drift": "E_V263_RECEIPT_ROUTE_DRIFT",
        }
