...
from scripts.v263.compatibility import load_compatibility_metadata, resolve_route
...
class TestV263CompatibilityAssets(unittest.TestCase):
    def test_packaged_manifest_is_typed_and_preserves_unsupported_routes(self) -> None:
        ...
        self.assertEqual("V2.63", metadata["product_version"])
