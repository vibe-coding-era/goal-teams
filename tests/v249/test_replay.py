...
from scripts.v249.test_gate import validate_current_route_closure


class TestV249ReplayIsolation(unittest.TestCase):
    ...
    def test_current_route_rejects_legacy_input(self) -> None:
        ...
        self.assertIn("E_V249_GENERATION_REPLAY_LEAK", verdict["errors"])
