...
SCHEMA_ROOT = REPO / "schemas/v2.49"
...
class TestV249SchemaContracts(unittest.TestCase):
    ...
    def test_required_fields_are_locally_declared_for_strict_draft202012_compilers(self) -> None:
        ...
        self.assertEqual(9, len(schema_files))
    ...
    def test_release_engine_profile_is_strict_compiler_and_instance_aligned(self) -> None:
        ...
        profile_path = REPO / "references/release-profiles/v2.49.json"
        ...
        v249_then = schema["allOf"][2]["then"]
        expected_gates = v249_then["properties"]["release_gates"]["const"]
        ...
        for field in ("s2_policy", "s3_policy"):
            ...
            self.assertEqual(
                v249_then["properties"][field]["const"], profile[field]
            )
    ...
    def test_s4_outcome_has_three_strict_terminal_branches_and_exact_assets(self) -> None:
        ...
        self.assertEqual(
            ["SHA256SUMS", "_files.sha256", "_release.json", "goal-teams-V2.49.tar.gz"],
