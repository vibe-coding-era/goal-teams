...
from scripts.v249.test_gate import (
    build_tdd_chain,
...
class TestV249SubagentAssurance(unittest.TestCase):
    ...
    def test_self_review_fails_tg08(self) -> None:
        ...
        self.assertIn("E_V249_TG08_ASSURANCE", verdict["errors"])
...
class TestV249RetryClassification(unittest.TestCase):
    def test_fail_then_pass_retry_cannot_be_reported_as_passed(self) -> None:
        ...
        self.assertFalse(verdict["ok"])
        self.assertIn("E_V249_TDD_FLAKE_MISCLASSIFIED", verdict["errors"])
