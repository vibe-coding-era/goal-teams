...
def _load_checker():
    spec = importlib.util.spec_from_file_location(
        "check_package_manifest_v263_candidate_closure", CHECKER
    )
...
class TestV263PackageCandidateClosure(unittest.TestCase):
    @classmethod
    ...
    def _fixture(
        ...
        temporary = tempfile.TemporaryDirectory(
            prefix="v263-package-candidate-", dir=DEVELOPS
        )
