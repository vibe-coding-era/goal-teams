...
class TestV265VersionMigration(unittest.TestCase):
    ...
    def test_current_manifests_package_and_compatibility_are_v268(self) -> None:
        ...
        for marker in (
            "product V2.68, core policy V2.5, Graph execution contract V2.65, legacy data schema V2.3",
            "prefix references/current/generations/V2.68/",
            "references/profiles/goal-teams-self-release-v2.68.md",
            ...
            "prefix scripts/v268/",
            "prefix schemas/v2.68/",
            "prefix tests/v268/",
            "prefix references/compatibility/v2.68/",
    ...
    def test_release_candidate_profile_and_changelog_are_truthful(self) -> None:
        path = ROOT / "references/release-profiles/v2.68.json"
        self.assertTrue(path.is_file(), "E_TEST_V268_RELEASE_PROFILE_MISSING")
