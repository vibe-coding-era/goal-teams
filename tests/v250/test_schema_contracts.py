...
RELEASE_SCHEMA_ROOT = REPO / "schemas/v2.68"
...
class TestV250SchemaContracts(unittest.TestCase):
    def test_predecessor_release_identity_contract_is_strict_and_valid(self) -> None:
        ...
        self.assertEqual("V2.68", contract["generation_id"])
        self.assertEqual("V2.67", contract["predecessor_product_version"])
    ...
    def test_activation_and_runtime_identity_versions_are_unambiguous(self) -> None:
        ...
        self.assertEqual(
            {"enum": ["V2.62", "V2.63", "V2.65", "V2.66", "V2.67", "V2.68"]},
        ...
        self.assertIn("installed_v267_current_state", signed_payload["required"])
    ...
    def test_release_engine_profile_is_strict_compiler_and_instance_aligned(self) -> None:
        ...
        profile_path = REPO / "references/release-profiles/v2.68.json"
    ...
    def test_s4_outcome_has_three_strict_terminal_branches_and_exact_assets(self) -> None:
        ...
        self.assertEqual(
            ["SHA256SUMS", "_files.sha256", "_release.json", "goal-teams-V2.68.tar.gz"],
