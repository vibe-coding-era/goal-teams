...
from scripts.v250.test_gate import validate_git_transport


class TestV250GitHubSsh(unittest.TestCase):
    ...
    def test_https_remote_fails_closed(self) -> None:
        ...
        self.assertIn("E_V250_GIT_TRANSPORT_NOT_SSH", verdict["errors"])
