...
class InactiveCandidateFixture:
    """Build a phase-independent, digest-selected V2.65 candidate repository."""
    ...
    def __enter__(self) -> CandidateFixture:
        ...
        self._temporary = tempfile.TemporaryDirectory(
            prefix="v265-inactive-candidate-", dir=develops
        )
        ...
        predecessor_path = fixture_root / V263_ACTIVATION_PATH
        ...
        active = {
            ...
            "updated_at": "2026-08-13T19:07:54+08:00",
        }
        ...
        if result.returncode != 0:
            raise AssertionError(
                "failed to build V2.65 inactive candidate fixture: "
                + hashlib.sha256(result.stderr.encode("utf-8")).hexdigest()
                + ": "
                + result.stderr.strip()
            )

        activation_path = fixture_root / V265_ACTIVATION_PATH
        ...
        return CandidateFixture(
            root=fixture_root,
            activation_path=V265_ACTIVATION_PATH,
