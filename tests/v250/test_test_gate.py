...
from scripts.v250.test_gate import build_tdd_chain, derive_gate_plan, validate_test_chain


class TestV250TestGate(unittest.TestCase):
    ...
    def test_case_drift_is_rejected(self) -> None:
        ...
        self.assertIn("E_V250_TDD_CASE_DRIFT", verdict["errors"])
