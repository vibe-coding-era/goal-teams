...
class TestV250VersionMigration(unittest.TestCase):
    def test_v263_current_identity_is_complete_and_predecessors_are_not_default(self) -> None:
        ...
        self.assertIn("prefix references/current/generations/V2.65/", package_manifest)
        ...
        self.assertIn("prefix schemas/v2.65/", package_manifest)
        self.assertIn("prefix scripts/v265/", package_manifest)
        self.assertIn("prefix tests/v265/", package_manifest)
        self.assertNotIn(
