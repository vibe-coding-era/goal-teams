...
from scripts.v262.compatibility import (
...
class TestV262RuntimeBindingContract(unittest.TestCase):
    @classmethod
    ...
    def _receipt(self) -> dict[str, object]:
        return {
            "schema_version": "goal-teams-runtime-binding-v2.62-v1",
            "binding_run_id": "RUN-V262-BINDING-0001",
    ...
    def test_binding_requires_run_identity_capture_time_and_exact_digests(self) -> None:
        ...
        expected = {
            "missing-run": "E_V262_RECEIPT_RUN_ID",
            "missing-time": "E_V262_RECEIPT_CAPTURED_AT",
            "digest-drift": "E_V262_RECEIPT_ROUTE_DRIFT",
        }
